...
@st.cache_data
def fetch_and_display_image(drive_link):
    shareable_link = get_shareable_link(drive_link)
    try:
...
drive_link = "https://drive.google.com/file/d/1whXNNfLjZvXNx7BcK44Fi5gmV08D_oQ-/view?usp=sharing"
logo_image = fetch_and_display_image(drive_link)
...
# Header with the fetched image
st.markdown(f"""
<header class="sticky-header">
  <img src="data:image/png;base64,{image_base64}" alt="NourishMe.AI Logo" class="logo">
    ...
    if mode == "Customized Details":
        ...
        with col2:
            ...
            st.session_state.goalof = st.selectbox("Workout/dietary goal",
                                                   ("Muscle Building", "Fitness", "Weight Loss", "General Health", "Not specific"),index = 4)
